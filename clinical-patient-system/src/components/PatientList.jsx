          ...
          {filteredPatients.map((patient) => {
            ...
            return (
              <button
                ...
                className={`w-full text-left bg-white rounded-lg border-2 p-4 transition-all hover:shadow-md focus:outline-none focus:ring-2 focus:ring-medical-500 focus:ring-offset-2 ${
                  status === 'completed'
